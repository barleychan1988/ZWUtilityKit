...
#define Nav_Left_BarItem_Offset (IOS7 ? -15.0f : -5.0f)
#define Nav_Right_BarItem_Offset (IOS7 ? -15.0f : -5.0f)
...
- (UIBarButtonItem*)createNavButton:(NSString *)strImageName highImage:(NSString *)strHighImage title:(NSString *)strTitle target:(id)target action:(SEL)btnAction offset:(float)offset;
